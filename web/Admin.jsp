...
<body>
  ...
  <div id="grand-div">
    ...
    <div class="gauche bg-text ">
        ...
        <div class="position-absolute  end-0 "style="top:1em; ">
            ...
            <div class="card w-50 text-light bg-light mx-auto" >
                <a href="auteur.jsp" style="text-decoration: none;" ></a>
            <img src="img/addbook.jpg" class="card-img-top" alt="Gerer les livres">
            <div class="card-body text-dark" id="card" >
                <p class="card-text"><div class="row"><div class="col"><a href="ajouterlivre.jsp"><button class="btn btn-warning bi bi-plus-square"> Crée Livre</button></a></div><div class="col"><a href="Livres"><button class="btn btn-warning bi bi-list"> Liste Livre</button></a></div></div></p>
            </div>
                </a>
            </div>
    </div>
    <div class="droit bg-text">
        <div class="card w-50  text-light bg-light mx-auto" >
            <a href="livre.jsp" style="text-decoration: none;" ></a>
        <img src="img/writer.jpg" class="card-img-top" alt="Gerer les livres">
        <div class="card-body text-dark" id="card">  
          <p class="card-text"><div class="row"><div class="col"><a href="ajouterAuteur.jsp"><button class="btn btn-warning bi bi-plus-square"> Crée auteur</button></a></div><div class="col"><a href="Auteurs"><button class="btn btn-warning bilistau bi-list"> Liste auteur</button></a></div></div></p>
        </div>
              </a>
        </div>
